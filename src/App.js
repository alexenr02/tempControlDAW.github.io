...
//  let temperatureValue = '10'
  ...
  let [temperatureValue, setTempValue] = useState(10)

    function colorTemperatura ()
    {
        if(temperatureValue >=20)
        {
            setTempColor(temperatureColor='hot')
        }
        if(temperatureValue < 20)
        {
            setTempColor(temperatureColor='cold')
        }
        
    }

    const sumarTemperatura = () => 
    {
        colorTemperatura();
        ...
        {
            setTempValue(temperatureValue = temperatureValue)
        }
        
    }

    const restarTemperatura = () => 
    {
        colorTemperatura();
  ...
  return (
    <div className="app-container">
      ...
      <div className="button-container">
        <button onClick={sumarTemperatura} >+</button>
        <button onClick={restarTemperatura}>-</button>
      </div>
    </div>
  );
}
